"""Load split YAML for Design agents."""
...
def load_design_agents() -> dict:
    return _merge("design_agents_*.yaml")


def load_design_tasks() -> dict:
    return _merge("design_tasks_*.yaml")
